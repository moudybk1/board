...
- Workspace ID: `4ebe9f56-95e9-4264-b2dc-029b65c527f4`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/4ebe9f56-95e9-4264-b2dc-029b65c527f4.
...
2. `npx ngodingpakeai connect --workspace 4ebe9f56-95e9-4264-b2dc-029b65c527f4 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/4ebe9f56-95e9-4264-b2dc-029b65c527f4. Only pass on links the CLI actually printed — never assemble one from an id yourself.
